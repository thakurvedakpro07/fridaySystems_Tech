 ...
 * GoogleLoginButton
 *
 * MUST be rendered as a child of <GoogleOAuthProvider> — never mount this
 * component unless VITE_GOOGLE_CLIENT_ID is set and the provider is present.
 * The parent pages (Login, RegisterCustomer) guard this with GOOGLE_ENABLED.
 *
 * This component is the single place in the codebase that calls useGoogleLogin.
 * Keeping the hook here (not in the page component) means page components never
 * touch Google APIs when Google is not configured.
 */
