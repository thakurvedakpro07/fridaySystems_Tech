...
export default function EmptyState({ icon, title, description, action, size = "default" }) {
  ...
  return (
    <div className={`flex flex-col items-center justify-center ${s.wrapper} text-center`}>
      <div className={`${s.iconBox} bg-slate-100 rounded-2xl flex items-center justify-center`}>
        {typeof icon === "string" ? (
