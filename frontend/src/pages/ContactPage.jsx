          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {isMobile ? (
              ...
              >
                ...
                <p className="text-xs text-slate-500 leading-relaxed">{CONTACT.businessHours}</p>
              </a>
            ) : (
              <div
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-12">
          ...
          <div className="space-y-5">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5">
              <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mb-4">Business Hours</p>
            ...
            {/* Office address */}
            <div className="bg-slate-50 border border-slate-200 rounded-2xl p-5">
              <p className="text-[10px] font-semibold text-slate-500 uppercase tracking-widest mb-3">Registered Office</p>
