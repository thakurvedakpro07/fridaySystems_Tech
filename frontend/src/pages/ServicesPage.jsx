...
const SERVICES = [
  ...
  },
  {
    ...
    desc: "Account setup, licence management, Outlook issues, Teams configuration, SharePoint permissions, OneDrive sync failures, and Exchange Online mail flow problems.",
    responseTime: "< 2 hours",
