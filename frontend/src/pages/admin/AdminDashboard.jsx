  ...
  return (
    ...
    >
      <div className="min-w-0">
        ...
        {sub && !loading && (
          <p className="text-xs text-slate-400 mt-2 font-medium truncate">{sub}</p>
        )}
      </div>
      {icon && (
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_300px] gap-8 items-start">
        ...
        <div className="min-w-0">
          <SectionHeader title="All Tickets">
            <Link to="/admin/analytics" className="text-xs font-medium text-slate-400 hover:text-slate-700 transition-colors">
              View analytics
            </Link>
          </SectionHeader>
